...
const ClassManagementMainScreen = ({ navigation }) => {
  ...
  const renderMenuButton = (title, subtitle, icon, color, onPress, enabled = true) => (
    <TouchableOpacity
    ...
    >
      <View style={styles.menuButtonContent}>
        ...
        <View style={styles.chevronContainer}>
          {enabled && <Ionicons name="chevron-forward" size={20} color="#BDC3C7" />}
        </View>
      </View>
    </TouchableOpacity>
  );
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.pageSubtitle}>Choose an option to manage your educational system</Text>
